  ...
  return (
    <div ref={$root}>
      <SVG ref={$svg} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 874.13 121' style={{ opacity: 0 }}>
        ...
        <g>
          <circle className='cls-2' cx='565.18' cy='70.53' r='29.68' transform='translate(-2.85 112.32) rotate(-11.32)' />
          <ellipse className='cls-2' cx='332.55' cy='76.78' rx='25.26' ry='27.78' />
          <path className='cls-2' d='M154.41,47.48c-11.62,0-19.87,7.08-22.57,19.7h44.79C175.45,55.73,167.88,47.48,154.41,47.48Z' />
          <path
            className='cls-2'
